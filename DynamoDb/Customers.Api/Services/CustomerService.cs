...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISnsMessager _sqsMessager;

    public CustomerService(ICustomerRepository customerRepository,
        IGitHubService gitHubService, ISnsMessager sqsMessager)
    {
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessager.PublishMessageAsync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer, DateTime requestStarted)
    {
        ...
        if (response)
        {
            await _sqsMessager.PublishMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _sqsMessager.PublishMessageAsync(new CustomerDelete()
            {
                Id = id
            });
        }
