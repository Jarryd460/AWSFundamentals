...
public class CustomerService : ICustomerService
{
    ...
    public CustomerService(ICustomerRepository customerRepository,
        IGitHubService gitHubService, ISqsMessager sqsMessager)
    {
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessager.SendMessageAsync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessager.SendMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _sqsMessager.SendMessageAsync(new CustomerDelete()
            {
                Id = id
            });
        }
